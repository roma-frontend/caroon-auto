...
export const get = query({
  ...
  handler: async (ctx) => {
    ...
    return settings ?? {
      ...
      enableLoyalty: false,
      loyaltyPercent: 1,
      enableBulkOrder: false,
      enableInstallVideos: false,
      enableTimeline: true,
      enablePlateDecoder: false,
    };
  },
});
  ...
  handler: async (ctx, args) => {
    ...
    if (existing) {
      ...
      await ctx.db.insert('settings', {
        ...
        enableCartRecovery: args.enableCartRecovery ?? false,
        cartRecoveryDelay: args.cartRecoveryDelay ?? 60,
        enablePriceAlert: args.enablePriceAlert ?? false,
        enableDailyReport: args.enableDailyReport ?? false,
        enablePickup: args.enablePickup ?? false,
        pickupAddress: args.pickupAddress ?? '',
        enableLoyalty: args.enableLoyalty ?? false,
        loyaltyPercent: args.loyaltyPercent ?? 1,
        enableBulkOrder: args.enableBulkOrder ?? false,
        enableInstallVideos: args.enableInstallVideos ?? false,
        enableTimeline: args.enableTimeline ?? true,
        enablePlateDecoder: args.enablePlateDecoder ?? false,
      });
    }
  },
});
