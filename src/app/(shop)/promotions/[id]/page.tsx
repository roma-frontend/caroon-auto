  ...
  return (
    <div className="mx-auto" style={{ maxWidth: 'var(--container-max)', paddingInline: 'var(--space-container)', paddingBlock: 'var(--space-8)' }}>
      ...
      <div className="overflow-hidden rounded-2xl border">
        {promo.imageUrl ? (
          <Image src={promo.imageUrl} alt={promo.title} width={1200} height={400} priority sizes="100vw" className="w-full aspect-video sm:aspect-[3/1] object-cover" />
        ) : (
          <div className="w-full aspect-video sm:aspect-[3/1] bg-gradient-to-br from-primary/10 to-primary/5 flex items-center justify-center">
